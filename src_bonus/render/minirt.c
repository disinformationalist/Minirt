...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/16 14:53:01 by jhotchki          #+#    #+#             */
/*   Updated: 2024/12/16 14:53:04 by jhotchki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// hourglass, test file: test_hourglass.rt
/* void	find_closest(t_trace *trace, t_ray ray, t_intersects *intersects)
{
	int	i;
...
// loop with single operations cu - cy, test file: test_csg_swimming_pool.rt
/* void	find_closest(t_trace *trace, t_ray ray, t_intersects *intersects)
{
	int	i;
	t_cylinder	*curr_cy;
...
// loop with single operations cu - sp, test file: test_csg_arcade.rt
/* void	find_closest(t_trace *trace, t_ray ray, t_intersects *intersects)
{
	int	i;
	t_sphere	*curr_sp;
