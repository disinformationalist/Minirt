...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   write_hyperboloids.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: arybarsk <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/18 18:52:14 by arybarsk          #+#    #+#             */
/*   Updated: 2024/11/18 18:52:15 by arybarsk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	write_hyperboloids(t_hyperboloid *hyperboloids, int fd)
{
	...
	if (hyperboloids == NULL)
		return ;
	ft_putstr_fd("#Hyperboloids: Cen_x | Cen_y | Cen_z      Nrm_x | Nrm_y | Nrm_z      rad1   rad2   Height       R | G | B\n", fd);
